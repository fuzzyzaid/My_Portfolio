    ...
    <div className={`container ${styles.customHeight}`}>
      <div className='row justify-content-center align-items-center'>
        <div className='col-12 col-lg-8 text-center text-md-start'>
          <h2 className={`display-4 mb-4 ${styles.textColor}`}>About Me</h2>
          <p className={`lead ${styles.textColor}`}>
           Hello Everyone. Welcome to my portfolio! I'm Zaid Alam, Full-Stack Developer with over three years of experience in crafting responsive websites. 
