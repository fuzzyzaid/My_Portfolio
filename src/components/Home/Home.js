  ...
  return (
    <div className="container">
      <div className={styles.menu}>
        ...
        <section id="contact">
          <p>Contact Me</p>
          <a href="mailto:zaidalam0731@gmail.com" target="_blank" rel="noopener noreferrer">
            Mail
          </a>
          <a href="https://www.linkedin.com/in/zaid-alam/" target="_blank" rel="noopener noreferrer">
            LinkedIn
          </a>
          <a href="https://github.com/fuzzyzaid" target="_blank" rel="noopener noreferrer">
            Github
          </a>
        </section>
      </div>
      <div className={styles.content} id="scrollable-content">
        <div className="section-wrapper">
          <section id="about" className={styles.section}>
            <h2>About Me</h2>
            <p>
              Experienced Full-Stack Developer with 3+ years in crafting responsive websites. Skilled in analyzing
              project requirements, adapting to new technologies, and integrating frontend and backend for cohesive
              solutions. Passionate about staying updated on industry trends and implementing best practices for
